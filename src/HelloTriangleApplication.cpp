...
static std::vector<char> readFile(const std::string &filename) {
  ...
  // use the read position to determin the size of the file and allocate a
  // buffer.
...
void HelloTriangleApplication::createSwapChain() {
  ...
  // Don't forget to get the swapchain images.
...
void HelloTriangleApplication::createDescriptorSetLayout() {
  ...
  VK_TRY(vkCreateDescriptorSetLayout(device, &layoutInfo, nullptr,
                                     &descriptorSetLayout),
...
void HelloTriangleApplication::createGraphicsPipeline() {
  ...
  VK_TRY(vkCreatePipelineLayout(device, &pipelineLayoutInfo, nullptr,
                                &pipelineLayout),
  ...
  VK_TRY(vkCreateGraphicsPipelines(device, VK_NULL_HANDLE, 1, &pipelineInfo,
...
void HelloTriangleApplication::createFramebuffers() {
  ...
  for (size_t i = 0; i < swapChainImageViews.size(); i++) {
    ...
    VK_TRY(vkCreateFramebuffer(device, &framebufferInfo, nullptr,
...
void HelloTriangleApplication::setupDebugMessenger() {
  ...
  VK_TRY(CreateDebugUtilsMessengerext(instance, &createInfo, nullptr,
                                      &debugMessenger),
...
HelloTriangleApplication::createShaderModule(const std::vector<char> &code) {
  ...
  VK_TRY(vkCreateShaderModule(device, &createInfo, nullptr, &shaderModule),
...
void HelloTriangleApplication::recordCommandBuffer(
  ...
  VK_TRY(vkEndCommandBuffer(commandBuffer), "failed to record command buffer!");
}
...
void HelloTriangleApplication::createImage(
  ...
  VK_TRY(vkCreateImage(device, &imageInfo, nullptr, &textureImage),
  ...
  VK_TRY(vkAllocateMemory(device, &allocInfo, nullptr, &textureImageMemory),
...
VkImageView HelloTriangleApplication::createImageView(VkImage image,
  ...
  VK_TRY(vkCreateImageView(device, &viewInfo, nullptr, &imageView),
